...
<body>
    ...
    <header>
        ...
        <h1 class="heading">Walchand Institute Of Technology, Solapur</h1>

    </header><br>

    <h1 style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande',

     'Lucida Sans Unicode', Geneva, Verdana, sans-serif;color:rgb(12, 12, 88);text-align: center;">
    ...
    <h1 class="footer-info">
		...
		<a href="cllglib3.jpg" style="font-size: 25px;margin-right: 220px;">WIT Solapur</a></div>
    ...
    <footer>
        ...
        <DIV style="padding-top: 30px;">
            ...
            <div class="cge-info">
                ...
                Walchand Institute of Technology, Solapur<br>

                P.B.No.634, Walchand Hirachand Marg,<br>

                Ashok Chowk, Solapur - 413006 (Maharashtra)<br>

                Phone : (0217)2652700, 2391700<br>

                Extn: 318, Fax:(0217)2651538<br>

                Email : principal@witsolapur.org<br>
